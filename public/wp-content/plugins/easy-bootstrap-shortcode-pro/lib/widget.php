<?php
/*
 * Create EBS Pro widget to parse any shortcode in sidebar
 */
...
class Ebs_Custom_Widget extends WP_Widget {
    ...
    function Ebs_Custom_Widget() {
        $widget_ops = array('classname' => 'ebs_custom_widget', 'description' => __('Ebs pro widget to show ebs pro shortcode in sidebar.','saket_wp'));

        $control_ops = array('id_base' => 'ebsp-widget');

        $this->WP_Widget('ebsp-widget', __('EBS Shortcode Compiler','saket_wp'), $widget_ops, $control_ops);
    }
    ...
    function form($instance) {
        $defaults = array('title' => 'EBSP Shortcode', 'ebs_content' => '');
