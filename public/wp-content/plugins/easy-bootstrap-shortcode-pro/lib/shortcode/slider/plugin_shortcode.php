...
function osc_theme_sliders($params, $content = null) {
    ...
    if (trim($scontent) != '' || count($_oscitas_slider[$id]['details'])) {
        ...
        if($bullets!=''){
            $output.=' <ol class="carousel-indicators'  .EBS_CONTAINER_CLASS. '">'.$bulllet_content.'</ol>';
        }
        ...
        if($controls!=''){
            $output.=' <a class="left carousel-control'  .EBS_CONTAINER_CLASS. '" href="#oscitas-slider-' . $id . '" data-slide="prev">
    <span class="glyphicon glyphicon-chevron-left"></span>
  </a>
  <a class="right carousel-control'  .EBS_CONTAINER_CLASS. '" href="#oscitas-slider-' . $id . '" data-slide="next">
